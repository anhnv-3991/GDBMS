...
template <typename T>
void GUtilities::ExclusiveScan(T *input, int ele_num, T *sum, cudaStream_t stream)
{
	thrust::device_ptr<T> dev_ptr(input);
...
template <typename T>
void GUtilities::ExclusiveScan(T *input, int ele_num, cudaStream_t stream)
{
	thrust::device_ptr<T> dev_ptr(input);
...
template <typename T>
void GUtilities::InclusiveScan(T *input, int ele_num)
{
	thrust::device_ptr<T> dev_ptr(input);
...
template <typename T>
void GUtilities::InclusiveScan(T *input, int ele_num, cudaStream_t stream)
{
	thrust::device_ptr<T> dev_ptr(input);
